...
export default function Inicio() {
  return (
    <>
      <section className="h-[150vh] lg:h-screen grid grid-col-1 lg:grid-cols-2 place-items-center selection:bg-cuarto" id='1'>
        <div className="font-Gabarito">
          <motion.h1 
          initial={{y : -50, opacity: 0}}
          animate={{y : 0, opacity: 1}}
          transition={{transition: 0.8}}
          className="font-Poppins text-6xl text-center lg:text-start text-transparent bg-clip-text bg-gradient-to-b from-secundario to-primario">
            UnCompa
          </motion.h1>
          <motion.h2
